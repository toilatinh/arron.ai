...
function HeaderMenu() {
  return (
    <div className="content-stretch flex font-['SF_UI_Display'] gap-[12px] items-center justify-end leading-[1.5] not-italic relative shrink-0 text-[15px] text-nowrap text-right text-zinc-400 tracking-[0.45px] whitespace-pre">
      <a href="https://drive.google.com/file/d/1i5EAqfELpZBT3nNpB9rFuvh0qIANjgNf/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="relative shrink-0 cursor-pointer hover:text-black transition-colors">Resume</a>
  ...
  return (
    <div className="relative shrink-0 w-full h-full overflow-y-auto no-scrollbar">
      <div className={`box-border content-stretch flex flex-col gap-[46px] min-h-full items-start pb-[200px] pt-[160px] ${paddingClass} transition-all duration-500 ease-in-out relative w-full`}>
        ...
        <div className="flex flex-col font-['SF_UI_Display:Medium',sans-serif] justify-center leading-[0] min-w-full not-italic relative shrink-0 text-[15px] text-black tracking-[0.45px] w-[min-content]">
          <p className="leading-[1.5]">My most recent chapter began in 2023, when I joined the <a href="https://aaron-ng.framer.ai/murror" target="_blank" rel="noopener noreferrer" style={{ color: "#FF7300" }}>Murror AI</a> with a mission to help young people through self-discovery and depression prevention. I lead AI behavior design, shaping how the AI thinks, speaks, and interacts as a supportive companion. This work now powers the entire product and has contributed to strong early PMF signals.</p>
        </div>
        <p className="font-['SF_UI_Display:Medium',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[15px] text-black tracking-[0.45px] w-[min-content]">Before that, I worked at One Mount, where I owned the <a href="https://aaron-ng.framer.ai/voucher" target="_blank" rel="noopener noreferrer" style={{ color: "#0077FF" }}>Voucher</a> domain in the VinID (now OneU) app, serving millions of users. I contributed across the full product cycle—research, usability testing, interviews, UI, and measurement. I also led the <a href="https://aaron-ng.framer.ai/om_portal" target="_blank" rel="noopener noreferrer" style={{ color: "#FF006F" }}>Loyalty Operation</a> project between Techcombank and VinID and built cross-team design processes for squads in both the North and South.</p>
        <p className="font-['SF_UI_Display:Medium',sans-serif] leading-[1.5] min-w-full not-italic relative shrink-0 text-[15px] text-black tracking-[0.45px] w-[min-content]">Earlier in my career, at age 20, I became a Product Designer at <a href="https://www.linkedin.com/company/pixiegroup/posts/?feedView=all" target="_blank" rel="noopener noreferrer" style={{ color: "#08B119" }}>Pixie</a>, where I built a mentoring platform that connected learners with industry mentors.</p>
